...
This repo is the technical source for the `support-doc-ingestion` skill package and the permanent live tracking repository for support-documentation research.
...
- Store live research-task records in `assignments/`, `completed-research/`, `agent-wiki-index/`, `transfer-log/`, `refresh-needed/`, and `open-questions/`.
